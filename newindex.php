...
<?php
    try{
        $user = "ユーザー名";
        $password = "パスワード";
        $pdo = new PDO("mysql:host=localhost;dbname=データベース名;charset=utf8", $user, $password);
        ...
        if (isset($_FILES['upfile']['error']) && is_int($_FILES['upfile']['error']) && $_FILES["upfile"]["name"] !== ""){
            ...
            elseif($extension === "mp4" || $extension === "MP4"){
                ...
                echo "非対応ファイルです．<br/>";
                echo ("<a href=\"newindex.php\">戻る</a><br/>");
                exit(1);
            }
...
<body>
    <form action="newindex.php" enctype="multipart/form-data" method="post">
